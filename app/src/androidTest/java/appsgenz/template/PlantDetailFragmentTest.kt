...
import appsgenz.template.activities.HomeActivity
import appsgenz.template.utilities.chooser
    ...
    fun jumpToPlantDetailFragment() {
        activityTestRule.activity.apply {
            runOnUiThread {
                ...
                findNavController(R.id.navHost).navigate(R.id.plant_detail_fragment, bundle)
            }
        }
    }
