...
Project Structure
---------------
1. activities: Name + Activity
2. adapters:
* `binding adapter`: Name + BindingAdapter
* `list adapter`: Name + Adapter
* `pager adapter`: Name + Adapter
3. api:
* `network api service`: Name + ApiService
4. base: base dialog, activity, fragment
5. data: core data, database, models response
* `dao`
* `entity`
* `model`
* `repository`
6. di: Dependency Injection
7. screens: fragments class screen
8. viewmodels: viewModel logic
9. views: custom view common
10. worker
